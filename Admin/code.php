...
<div class="row">
                ...
                <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-sm-10 offset-sm-1" >
                            ...
                            <form action="updatecourseform.php" method="post">
                                ...
                                <div class="form-actions form-group"><center><button type="submit" name="updatecourse" class="btn btn-success btn-lg"><i class="fa fa-edit"></i>Edit</button></center></div>
                            </form>
                    </div>
